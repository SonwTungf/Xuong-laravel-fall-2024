...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('sales')->insert([
            ...
            ['product_id' => 2, 'quantity' => 2, 'price' => 1500000, 'tax' => 330000, 'total' => 7500000, 'sale_date' => '2024-09-16', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['product_id' => 3, 'quantity' => 1, 'price' => 2000000, 'tax' => 660000, 'total' => 6600000, 'sale_date' => '2024-09-15', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['product_id' => 4, 'quantity' => 2, 'price' => 1500000, 'tax' => 330000, 'total' => 7500000, 'sale_date' => '2024-09-16', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ]);
        ...
        DB::table('expenses')->insert([
            ...
            ['description' => 'bao? hanh', 'amount' => 800000, 'expense_date' => '2024-09-05', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['description' => 'luong nv thang 9', 'amount' => 1000000, '12000000' => '2024-09-06', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ]);
